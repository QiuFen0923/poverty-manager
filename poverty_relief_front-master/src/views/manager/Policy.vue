...
<!--        <el-table-column prop="content" label="内容" show-overflow-tooltip>-->
        ...
        <el-table-column label="内容" show-overflow-tooltip>
          <template v-slot = "scope">
            <el-button  type="primary" size="mini" @click ="viewEditor(scope.row.content)">查看</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="180" align="center">
          <template v-slot="scope">
            <el-button plain type="primary" @click="updateEdit(scope.row)" size="mini">编辑</el-button>
    ...
    <el-dialog title="政策发布" :visible.sync="fromVisible" width="60%" :close-on-click-modal="false" destroy-on-close @close="cancel">
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        <el-form-item label="标题" prop="title">
          <el-input v-model="form.title" placeholder="标题内容"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    load(pageNum) {  // 分页查询
      ...
      this.$request.get('/notice/selectPage2', {
        params: {
